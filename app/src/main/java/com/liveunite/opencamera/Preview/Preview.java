package com.liveunite.opencamera.Preview;
...
import com.liveunite.opencamera.CameraController.CameraController1;
import com.liveunite.opencamera.CameraController.CameraController2;
import com.liveunite.opencamera.CameraController.CameraControllerException;
import com.liveunite.opencamera.CameraController.CameraControllerManager;
import com.liveunite.opencamera.CameraController.CameraControllerManager1;
import com.liveunite.opencamera.CameraController.CameraControllerManager2;
import com.liveunite.opencamera.MyDebug;
import com.liveunite.opencamera.Preview.ApplicationInterface.NoFreeStorageException;
import com.liveunite.opencamera.Preview.CameraSurface.CameraSurface;
import com.liveunite.opencamera.Preview.CameraSurface.MySurfaceView;
import com.liveunite.opencamera.Preview.CameraSurface.MyTextureView;
import com.liveunite.opencamera.ToastBoxer;
...
public class Preview implements SurfaceHolder.Callback, TextureView.SurfaceTextureListener
{
    ...
    private void startVideoRecording(boolean max_filesize_restart)
    {
        ...
        if (created_video_file)
        {
            ...
            {
                //change it if needed
                String pref_audio_src = "audio_src_default";
                if (MyDebug.LOG)
            ...
            try
            {
                ...
                final long battery_check_interval_ms = 3 * 60 * 1000; //3 mins
